---
mode: agent
description: Create and maintain minimal override translation units for ScummVM wrapper compatibility. Use when an upstream source in ScummVMEngine/ cannot be built as-is and must be replaced by a file in Sources/ScummVMEngineOverrides/ with a synchronized exclusion in Package.swift.
---
...
- Never edit `ScummVMEngine/` directly.
...
3. Create a mirrored override path under `Sources/ScummVMEngineOverrides/`.
