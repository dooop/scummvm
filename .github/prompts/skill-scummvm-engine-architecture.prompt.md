---
mode: agent
description: Provide architecture-level orientation for how the Swift and Android wrappers host ScummVM. Use when planning or reviewing engine startup, platform backends, JNI or Objective-C++ integration, plugin registration, runtime resources, or wrapper boundaries.
---
