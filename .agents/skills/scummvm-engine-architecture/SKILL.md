...
description: Provide architecture-level orientation for how the Swift wrapper hosts ScummVM and where responsibilities live. Use when planning or reviewing changes that touch engine startup, platform backends, plugin registration, runtime resources, or wrapper boundaries.
---
