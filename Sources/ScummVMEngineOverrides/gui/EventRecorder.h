...
private:
	...
	// Declared unconditionally: the out-of-line definition in EventRecorder.cpp
	// always exists (falling back to `return false;` without USE_IMGUI), and
	// several call sites there are not themselves USE_IMGUI-guarded.
